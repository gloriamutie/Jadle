...
public void getNameReturnsCorrectName() throws Exception{
		...
		assertEquals ("Moriah", testRestaurant.getName());
	}
	
	@Test
public void getAddressReturnsCorrectAddress() throws Exception{
		Restaurant testRestaurant = setupRestaurant();
		assertEquals ("214 NE Broadway", testRestaurant.getName());
	}
    ...
    @Test
      ...
      public void setNameSetsCorrectame() throws Exception{
		Restaurant testRestaurant = setupRestaurant();
		testRestaurant.setName("Treehouse");
		assertNotEquals ("Moriah",testRestaurant.getName());
